...
/*   Updated: 2025/01/14 16:56:02 by ynzue-es         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cost_push(t_stack *stack_a, t_stack *stack_b)
{
	...
	while (i_b >= 0)
	{
		...
		if (cost_logic(cost.a_top, cost.b_top, cost.a_bottom,
				cost.b_bottom) < min_cost)
		{
			min_cost = cost_logic(cost.a_top, cost.b_top, cost.a_bottom,
					cost.b_bottom);
			ind_min_cost = i_b;
		}
		i_b--;
